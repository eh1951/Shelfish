...
function connectDatabase($server, $user, $password,$database) {
	...
	if(!($dbLink = mysqli_connect($server, $user, $password)))
	{
		print("Utterly failed to connect to database on ".$server."<br>\n");
		print("Aborting!<br>\n");
		exit();
	}
